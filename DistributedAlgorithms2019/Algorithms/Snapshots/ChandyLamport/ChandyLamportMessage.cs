////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\ChandyLamport\ChandyLamportMessage.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.ChandyLamport
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \class ChandyLamportMessage
    ///
    /// \brief A ChandyLamport message.
    ///
    /// \par Usage Notes. 
    ...
    ///      a ChandyLamportMessage as a parameter)
    ///      
    ...
    public class ChandyLamportMessage : BaseMessage
    {
        #region /// \name Constructors

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamportMessage() : base()
        ///
        ...
        public ChandyLamportMessage() : base() { }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamportMessage(BaseNetwork network, object messageType, AttributeDictionary fields, BaseChannel channel, string messageName, int round, int logicalClock):base(network, messageType, fields, channel, messageName, round, logicalClock)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamportMessage(BaseNetwork network,
            object messageType, 
