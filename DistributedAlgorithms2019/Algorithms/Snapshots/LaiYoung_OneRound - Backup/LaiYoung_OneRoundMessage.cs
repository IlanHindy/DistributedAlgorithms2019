////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\LaiYoung_OneRound\LaiYoung_OneRoundMessage.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.LaiYoung_OneRound
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \class LaiYoung_OneRoundMessage
    ///
    /// \brief A LaiYoung_OneRound message.
    ///
    /// \par Usage Notes. 
    ...
    ///      a LaiYoung_OneRoundMessage as a parameter)
    ///      
    ...
    public class LaiYoung_OneRoundMessage : BaseMessage
    {
        #region /// \name Constructors

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LaiYoung_OneRoundMessage() : base()
        ///
        ...
        public LaiYoung_OneRoundMessage() : base() { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LaiYoung_OneRoundMessage(LaiYoung_OneRoundNetwork network):base(network)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public LaiYoung_OneRoundMessage(LaiYoung_OneRoundNetwork network):base(network)
        { }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LaiYoung_OneRoundMessage(BaseNetwork network, object messageType, AttributeDictionary fields, BaseChannel channel, string messageName, int round, int logicalClock):base(network, messageType, fields, channel, messageName, round, logicalClock)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public LaiYoung_OneRoundMessage(BaseNetwork network,
            object messageType, 
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LaiYoung_OneRoundMessage(LaiYoung_OneRoundNetwork network, string messageString):base(network, messageString)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public LaiYoung_OneRoundMessage(LaiYoung_OneRoundNetwork network, string messageString):base(network, messageString)
        {
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LaiYoung_OneRoundMessage(LaiYoung_OneRoundNetwork network, object messageType, int sourceProcess, int sourcePort, int destProcess, int destPort, string messageName, int round, int logicalClock) : base(network, messageType, sourceProcess, sourcePort, destProcess, destPort, messageName, round, logicalClock)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public LaiYoung_OneRoundMessage(LaiYoung_OneRoundNetwork network,
            object messageType,
            int sourceProcess,
            int sourcePort,
            int destProcess,
