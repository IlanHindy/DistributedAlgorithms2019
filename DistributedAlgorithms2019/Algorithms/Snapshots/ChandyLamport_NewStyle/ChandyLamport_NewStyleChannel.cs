////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\ChandyLamport_NewStyle\ChandyLamport_NewStyleChannel.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.ChandyLamport_NewStyle
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \class ChandyLamport_NewStyleChannel
    ///
    ...
    public partial class ChandyLamport_NewStyleChannel : BaseChannel
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleChannel() : base()
        ///
        ...
        public ChandyLamport_NewStyleChannel() : base() { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleChannel(ChandyLamport_NewStyleNetwork network) : base(network)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_NewStyleChannel(ChandyLamport_NewStyleNetwork network) : base(network) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleChannel(bool PermissionsValue) : base(PermissionsValue)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_NewStyleChannel(bool PermissionsValue) : base(PermissionsValue) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleChannel(ChandyLamport_NewStyleNetwork network, int id, int sourceProcessId, int destProcessId) : base(network, id, sourceProcessId, destProcessId)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_NewStyleChannel(ChandyLamport_NewStyleNetwork network, int id, int sourceProcessId, int destProcessId) 
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool ChandyLamport_NewStyleChannelDefaultAttributeCheck(ChandyLamport_NewStyleNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///       pa.Add(c.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  ChandyLamport_NewStyleChannelDefaultAttributeCheck})
        /// ~~~ 
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        public static bool ChandyLamport_NewStyleChannelDefaultAttributeCheck(ChandyLamport_NewStyleNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
        ...
        public string MessageList()
        {
            ...
            if (State.Count > 0)
            {
                s = "From " + SourceProcess.ToString() + ": ";
                for (int idx = 0; idx < State.Count; idx++)
                {
                    s += State[idx] + "; ";
                }
            }
            return s;
            //string s = "";
            //if (or[c.ork.State].Count > 0)
            //{
            //    s = "From " + ea[bc.eak.SourceProcess].ToString() + ": ";
            //    for (int idx = 0; idx < or[c.ork.State].Count; idx++)
            //    {
            //        s += or[c.ork.State][idx] + "; ";
            //    }
            //}
            //return s;
        }
