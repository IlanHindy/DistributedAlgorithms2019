////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\ChandyLamport_NewStyle\ChandyLamport_NewStyleMessage.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.ChandyLamport_NewStyle
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \class ChandyLamport_NewStyleMessage
    ///
    /// \brief A ChandyLamport_NewStyle message.
    ///
    /// \par Usage Notes. 
    ...
    ///      a ChandyLamport_NewStyleMessage as a parameter)
    ///      
    ...
    public partial class ChandyLamport_NewStyleMessage : BaseMessage
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage() : base()
        ///
        ...
        public ChandyLamport_NewStyleMessage() : base() { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network):base(network)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network):base(network)
        { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, ChandyLamport_NewStyleMessage sourceMessage): base(network, sourceMessage)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        ///
        /// \param network       (ChandyLamport_NewStyleNetwork) - The network.
        /// \param sourceMessage (ChandyLamport_NewStyleMessage) - Message describing the source.
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, ChandyLamport_NewStyleMessage sourceMessage): base(network, sourceMessage)
        {
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleMessage sourceMessage, ChandyLamport_NewStyleChannel sendingChannel): base(sourceMessage, sendingChannel)
        ///
        /// \brief Constructor.
        ///
        /// \par Description. 
        ...
        ///
        /// \param sourceMessage  (ChandyLamport_NewStyleMessage) - Message describing the source.
        /// \param sendingChannel (ChandyLamport_NewStyleChannel) - The sending channel.
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, ChandyLamport_NewStyleMessage sourceMessage, ChandyLamport_NewStyleChannel sendingChannel):
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, string messageString):base(network, messageString)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, string messageString):base(network, messageString)
        {
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, object messageType, int sourceProcess, int sourcePort, int destProcess, int destPort, string messageName, int round, int logicalClock) : base(network, messageType, sourceProcess, sourcePort, destProcess, destPort, messageName, round, logicalClock)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network,
            object messageType,
            int sourceProcess,
            int sourcePort,
            int destProcess,
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, object messageType, ChandyLamport_NewStyleChannel channel, string messageName, int round = 0, int logicalClock = 0): base(network, messageType, channel, messageName, round, logicalClock)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        /// \param network       (ChandyLamport_NewStyleNetwork) - The network.
        /// \param messageType  (dynamic) - Type of the message.
        /// \param channel      (ChandyLamport_NewStyleChannel) - The channel.
        /// \param messageName   (string) - Name of the message.
        /// \param round        (Optional)  (int) - The round.
        /// \param logicalClock (Optional)  (int) - The logical clock.
        ///
        ...
        public ChandyLamport_NewStyleMessage(ChandyLamport_NewStyleNetwork network, object messageType, ChandyLamport_NewStyleChannel channel, string messageName, int round = 0, int logicalClock = 0):
