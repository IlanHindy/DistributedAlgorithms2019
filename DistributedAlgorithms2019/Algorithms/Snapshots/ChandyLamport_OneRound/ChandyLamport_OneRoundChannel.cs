////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\ChandyLamport_OneRound\ChandyLamport_OneRoundChannel.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.ChandyLamport_OneRound
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \class ChandyLamport_OneRoundChannel
    ///
    ...
    public partial class ChandyLamport_OneRoundChannel : BaseChannel
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_OneRoundChannel() : base()
        ///
        ...
        public ChandyLamport_OneRoundChannel() : base() { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_OneRoundChannel(ChandyLamport_OneRoundNetwork network) : base(network)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_OneRoundChannel(ChandyLamport_OneRoundNetwork network) : base(network) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_OneRoundChannel(bool PermissionsValue) : base(PermissionsValue)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_OneRoundChannel(bool PermissionsValue) : base(PermissionsValue) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamport_OneRoundChannel(ChandyLamport_OneRoundNetwork network, int id, int sourceProcessId, int destProcessId) : base(network, id, sourceProcessId, destProcessId)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public ChandyLamport_OneRoundChannel(ChandyLamport_OneRoundNetwork network, int id, int sourceProcessId, int destProcessId) 
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool ChandyLamport_OneRoundChannelDefaultAttributeCheck(ChandyLamport_OneRoundNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///       pa.Add(c.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  ChandyLamport_OneRoundChannelDefaultAttributeCheck})
        /// ~~~ 
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        public static bool ChandyLamport_OneRoundChannelDefaultAttributeCheck(ChandyLamport_OneRoundNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
