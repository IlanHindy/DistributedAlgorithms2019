////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\Echo\EchoNetwork.cs
///
...
namespace DistributedAlgorithms.Algorithms.Waves.Echo
{
    ...
    public partial class EchoNetwork : BaseNetwork
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool EchoNetworkDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///      attribute.EndInputOperationMethod =  EchonetworkDefaultAttributeCheck
        ///      
        ///      // Setting the method to an attribute while creation
        ///      pa.Add(n.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  EchonetworkDefaultAttributeCheck})
        /// ~~~
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        public static bool EchoNetworkDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
