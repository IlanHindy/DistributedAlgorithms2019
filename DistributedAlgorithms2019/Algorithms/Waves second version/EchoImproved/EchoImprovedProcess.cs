...
namespace DistributedAlgorithms.Algorithms.Waves.EchoImproved
{
    ...
    ///     protected List<EchoImprovedChannel> InChannels()
    ///      
    ///     // List of all the outgoing channels without the self connecting channel
    ///     protected List<EchoImprovedChannel> OutChannels()
    ///     
    ...
    public partial class EchoImprovedProcess : BaseProcess
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public EchoImprovedProcess() : base()
        ///
        ...
        public EchoImprovedProcess() : base() { }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public EchoImprovedProcess(bool permitionsValue) : base(permitionsValue)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public EchoImprovedProcess(bool permitionsValue) : base(permitionsValue) { }
        ...
        ///       pa.Add(p.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  EchoImprovedChannelDefaultAttributeCheck})
        /// ~~~
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        ///      -#   This method is activated only onece at the beginning of running of the initiator
        ...
        protected override void RunAlgorithm()
        {
            ...
            {
                SendWave(SelectingMethod.All, null);
            }
        }
        ...
        public override void ReceiveHandling(BaseMessage message)
        {
            ...
            {
                or[p.ork.Parent] = message[m.fieldKeys.Sender];
                if (OutChannels.Count > 1)
                {
                    SendWave(SelectingMethod.Exclude, new List<int> { or[p.ork.Parent] });
                }
                else
                {                    
                    SendWave(SelectingMethod.Include, new List<int> { or[p.ork.Parent] });
                }
            }
            else
            {
                if (or[p.ork.Received] == OutChannels.Count)
                {
                    ...
                    {
                        MessageRouter.MessageBox(new List<string> { "Algorithms finished start terminating" });
                        Terminate();
                    }
                }
            }
        ...
        ///
        /// \par Usage Notes. 
        ///      - Change this method if you want to add fields to the base algorithm messege  
        ...
        private void SendWave(SelectingMethod selectingMethod = SelectingMethod.Include,  List<int> ids = null)
        {
            ...
            fields.Add(m.fieldKeys.Sender, new Attribute { Value = ea[ne.eak.Id] });
