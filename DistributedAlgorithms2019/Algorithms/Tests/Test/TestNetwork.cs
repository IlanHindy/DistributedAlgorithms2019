////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\Test\TestNetwork.cs
///
...
namespace DistributedAlgorithms.Algorithms.Tests.Test
{
    ...
    public partial class TestNetwork : BaseNetwork
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool TestNetworkDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///      attribute.EndInputOperationMethod =  TestnetworkDefaultAttributeCheck
        ///      
        ///      // Setting the method to an attribute while creation
        ///      pa.Add(n.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  TestnetworkDefaultAttributeCheck})
        /// ~~~
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        public static bool TestNetworkDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
