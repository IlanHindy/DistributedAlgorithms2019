////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\Test\TestChannel.cs
///
...
namespace DistributedAlgorithms.Algorithms.Tests.Test
{
    ...
    public partial class TestChannel : BaseChannel
    {
        ...
        public TestChannel() : base() { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public TestChannel(TestNetwork network) : base(network)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public TestChannel(TestNetwork network) : base(network) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public TestChannel(bool PermissionsValue) : base(PermissionsValue)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public TestChannel(bool PermissionsValue) : base(PermissionsValue) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public TestChannel(TestNetwork network, int id, int sourceProcessId, int destProcessId) : base(network, id, sourceProcessId, destProcessId)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public TestChannel(TestNetwork network, int id, int sourceProcessId, int destProcessId) 
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool TestChannelDefaultAttributeCheck(TestNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///       pa.Add(c.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  TestChannelDefaultAttributeCheck})
        /// ~~~ 
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        public static bool TestChannelDefaultAttributeCheck(TestNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
