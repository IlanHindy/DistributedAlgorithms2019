////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\Template\TemplateProcess.cs
///
...
namespace DistributedAlgorithms.Algorithms.Templates.Template
{
    ...
    public partial class TemplateProcess : BaseProcess
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public TemplateProcess() : base()
        ///
        ...
        public TemplateProcess() : base() { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public TemplateProcess(TemplateNetwork network) : base(network)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public TemplateProcess(TemplateNetwork network) : base(network) { }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public TemplateProcess(bool permissionsValue) : base(permissionsValue)
        ///
        /// \brief Constructor.
        ///
        /// \par Description.
        ...
        public TemplateProcess(bool permissionsValue) : base(permissionsValue) { }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool TemplateProcessDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///       pa.Add(p.pak.SomeKey, new Attribute {Value = SomeValue, EndInputOperationMethod =  TemplateChannelDefaultAttributeCheck})
        /// ~~~
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ...
        public static bool TemplateProcessDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
        ...
        {
            // Note - Remove the following line because your algorithm does not need to operate
