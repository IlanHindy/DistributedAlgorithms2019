////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\EchoImproved\EchoImprovedNetwork.cs
///
...
namespace DistributedAlgorithms.Algorithms.Waves.EchoImproved
{
    ...
    class EchoImprovedNetwork : BaseNetwork
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public override void Init(int idx, bool clearPresentation = true)
        {
            ...
            ElementAttributes.Value[ElementAttributeKeys.DirectedNetwork].Value = false;
            ElementAttributes.Value[ElementAttributeKeys.Centrilized].Value = true;
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool EchoImprovedNetworkDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///     -# `attribute.EndInputOperationMethod =  EchoImprovednetworkDefaultAttributeCheck`
        ///     -# `PrivateAttributes.Value.Add(PrivateAttributeKeys.SomeKey, new Attribute {Value = SomeValue,
        ///         EndInputOperationMethod =  EchoImprovednetworkDefaultAttributeCheck})`
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public static bool EchoImprovedNetworkDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
