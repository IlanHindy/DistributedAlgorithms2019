...
namespace DistributedAlgorithms.Algorithms.Waves.EchoImproved
{
    ...
    class EchoImprovedChannel : BaseChannel
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public EchoImprovedChannel()
        {
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public EchoImprovedChannel(int id, int sourceProcessId, int destProcessId, BaseNetwork network) : base(id, sourceProcessId, destProcessId, network)
        ///
        /// \brief Constructor.
        ///
        /// \brief #### Description.
        ...
        public EchoImprovedChannel(int id, int sourceProcessId, int destProcessId, BaseNetwork network) :
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool EchoImprovedChannelDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///  EndInputOperationMethod =  EchoImprovedChannelDefaultAttributeCheck})`.
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ///
        ...
        public static bool EchoImprovedChannelDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
