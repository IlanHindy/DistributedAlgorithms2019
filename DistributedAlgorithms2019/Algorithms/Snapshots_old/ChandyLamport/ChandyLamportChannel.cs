////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\ChandyLamport\ChandyLamportChannel.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.ChandyLamport
{
    ...
    class ChandyLamportChannel : BaseChannel
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public new enum OperationResultKeys { MarkerArrived, ChannelMessages }
        #region constructors

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamportChannel()
        ///
        ...
        public ChandyLamportChannel()
        {
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public ChandyLamportChannel(int id, int sourceProcessId, int destProcessId, BaseNetwork network) : base(id, sourceProcessId, destProcessId, network)
        ///
        /// \brief Constructor.
        ///
        /// \brief #### Description.
        ...
        public ChandyLamportChannel(int id, int sourceProcessId, int destProcessId, BaseNetwork network) :
        ...
        protected override void InitOperationResults.Value()
        {
            ...
            OperationResults.Value.Add(OperationResultKeys.MarkerArrived, new Attribute { Value = false });
            OperationResults.Value.Add(OperationResultKeys.ChannelMessages, new Attribute { Value = new AttributeList() });
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool ChandyLamportChannelDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        ///  EndInputOperationMethod =  ChandyLamportChannelDefaultAttributeCheck})`.
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ///
        ...
        public static bool ChandyLamportChannelDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
        ...
        public void AddMessage(BaseMessage message)
        {
            ...
            channelMessages.Add(new Attribute { Value = messageString });
        }

        public void ClearMessages()
        {
            OperationResults.Value[OperationResultKeys.ChannelMessages].Value = new AttributeList();
        }
        public void UpdatePresentation()
        {
            AttributeList channelMessages = OperationResults.Value[OperationResultKeys.ChannelMessages].Value;
            string channelPresentationText = OperationResults.Value[OperationResultKeys.MarkerArrived].Value.ToString();
            channelPresentationText += "  ";
            foreach (Attribute attribute in channelMessages)
            {
                channelPresentationText += attribute.Value + ",";
            }
            PresentationParameters[BaseChannel.PresentationParameterKeys.PresentationText].Value = channelPresentationText;
            //CustomizedMessageBox.Show(" *** " + PresentationParameters[PresentationParameterKeys.PresentationText].Value, "", Icons.Info);
        }
        #endregion
    }
}
