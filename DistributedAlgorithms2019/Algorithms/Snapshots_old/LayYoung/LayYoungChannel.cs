////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Algorithms\System\LayYoung\LayYoungChannel.cs
///
...
namespace DistributedAlgorithms.Algorithms.Snapshots.LayYoung
{
    ...
    class LayYoungChannel : BaseChannel
    {
        #region Enums
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public new enum OperationResultKeys {Sent, Expected, Count, State, Weight, PrevRoundCount}
        #endregion
        #region constructors

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LayYoungChannel()
        ///
        ...
        public LayYoungChannel()
        {
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public LayYoungChannel(int id, int sourceProcessId, int destProcessId, BaseNetwork network) : base(id, sourceProcessId, destProcessId, network)
        ///
        /// \brief Constructor.
        ///
        /// \brief #### Description.
        ...
        public LayYoungChannel(int id, int sourceProcessId, int destProcessId, BaseNetwork network) :
        ...
        protected override void InitOperationResults.Value()
        {
            ...
            OperationResults.Value.Add(OperationResultKeys.Sent, new Attribute { Value = 0 });
            OperationResults.Value.Add(OperationResultKeys.Count, new Attribute { Value = 0 });
            OperationResults.Value.Add(OperationResultKeys.Expected, new Attribute { Value = 0 });
            OperationResults.Value.Add(OperationResultKeys.State, new Attribute { Value = new AttributeList() });
            OperationResults.Value.Add(OperationResultKeys.Weight, new Attribute { Value = 0 });
            OperationResults.Value.Add(OperationResultKeys.PrevRoundCount, new Attribute { Value = 0 });
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \fn public static bool LayYoungChannelDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        ///
        ...
        /// -# `attribute.EndInputOperationMethod =  LayYoungChannelDefaultAttributeCheck`
        /// -# `PrivateAttributes.Value.Add(PrivateAttributeKeys.SomeKey, new Attribute {Value = SomeValue,
        ///  EndInputOperationMethod =  LayYoungChannelDefaultAttributeCheck})`.
        ///
        /// \author Ilan Hindy
        /// \date 24/01/2017
        ///
        ...
        public static bool LayYoungChannelDefaultAttributeCheck(BaseNetwork network, NetworkElement networkElement, Attribute parentAttribute, Attribute attribute, string newValue, out string errorMessage)
        {
            errorMessage = "";
            return true;
        }
        ...
        {
            if (OperationResults.Value[OperationResultKeys.Weight].Value == 0)
            {
                return false;
            }

            if (OperationResults.Value[OperationResultKeys.State].Value.Count < 
                OperationResults.Value[OperationResultKeys.Expected].Value)
            {
                return false;
            }
            return true;
        ...
        public void AddToState(BaseMessage message)
        {
            ...
            state.Add(new Attribute { Value = message });
        }
        #endregion
    }
}
